...
public class ArticleListActivity extends ActionBarActivity implements
        LoaderManager.LoaderCallbacks<Cursor>, MyDialog.MyDialogListener{

    private final static String LOG_TAG = ArticleListActivity.class.getName();
    ...
    public void onDialogNegativeClick(DialogFragment dialog) {
        Toast toast = Toast.makeText(getApplicationContext(), "Negative", Toast.LENGTH_LONG);
        toast.show();
